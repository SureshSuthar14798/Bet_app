...
const MatchCard: React.FC<MatchCardProps> = ({ match, onBetSelect, selectedBetId }) => {
  ...
  return (
    <div className="group relative">
      ...
      <div
        className="relative bg-white dark:bg-[#08080c] border border-slate-200 dark:border-white/10 rounded-[1.5rem] overflow-hidden transition-all hover:border-neon-red/30 shadow-xl flex flex-col group/card"
      ...
      >
        ...
        <div className="relative h-48 overflow-hidden bg-slate-950">
          ...
          {/* Static Fallback / Background Image */}
          <div
            className={`absolute inset-0 z-0 bg-cover bg-center transition-all duration-1000 group-hover/card:scale-110 ${showVideo ? 'opacity-100 group-hover/card:opacity-0' : 'opacity-100'}`}
          ...
          {showVideo && (
            <video
              ...
              className="absolute inset-0 z-10 w-full h-full object-cover opacity-0 transition-all duration-1000 group-hover/card:opacity-60 group-hover/card:scale-105"
