  ...
  return (
    <div className="max-w-6xl mx-auto lg:py-6 w-full">
      ...
      <PageHeader 
        ...
        subtitle="Historical extraction records"
        onBack={onBack}
      />
        ...
        <div className="flex md:inline-flex bg-slate-200 dark:bg-white/5 p-1 rounded-xl gap-1 min-w-max md:min-w-0">
          {filters.map((filter) => (
            <button
              ...
              className={`flex-1 md:flex-none px-2 md:px-6 py-2.5 text-[10px] font-black uppercase tracking-widest rounded-lg whitespace-nowrap
                ${activeFilter === filter 
